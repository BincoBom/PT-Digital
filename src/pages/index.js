...
import { Theme, Link, Image, Span, Text, Section, Box, Hr, Button, Strong, Icon } from "@quarkly/widgets";
			...
			>
				...
				>
					...
					<Text as="p" font="normal 500 16px/1.5 --fontFamily-googleInter" margin="12px 0" color="--greyD2">
						От 2 до 5 категорий в любых разделах. Для опытных и отличных мастеров подходит идиально.
					</Text>
					<Button
						border-radius="30px"
						hover-background="--color-dark"
				...
				>
					...
					>
						От 10 до 12 категорий в любых разделах. Выбор малого и среднего бизнеса для увеличения количества клиентов и  развития своей компании.
					</Text>
					<Button
						border-radius="30px"
						hover-background="--color-dark"
		...
		<Section padding="20px 0 30px 0" sm-padding="40px 0">
			...
			<Stack>
				...
				<StackItem
					...
					align-self="auto"
				>
					<Override slot="StackItemContent" display="flex" align-self="auto" />
					{"        "}
					<Text
						as="p"
...
2021, ООО PT Digital.
				...
				{"    "}
				<StackItem width="50%" sm-width="30%" sm-padding="10px 16px 16px 16px" display="block">
					<Override slot="StackItemContent" justify-content="flex-end" />
					<StackItem width="100%" sm-width="30%" sm-padding="10px 16px 16px 16px" display="inline">
						<Override slot="StackItemContent" justify-content="flex-end" display="block" />
					...
					>
						<Override slot="StackItemContent" justify-content="flex-end" display="flex" />
						<Icon
							category="ai"
